...
import { Book, CheckCircle, PenTool, LayoutDashboard, Settings, Library, Microscope, Eye, Headphones, FileSearch, Users, Ear, Search, LayoutGrid, Brain, PieChart, History } from 'lucide-react';
...
>>>>>>> 8e0541c62e9f3d0671ccde66e1831c4f33e95cfc
          ...
          <div className="mt-auto flex flex-col gap-2 py-4 w-full items-center border-t border-white/5">
            <button 
              ...
              className={`flex flex-col items-center justify-center w-full py-2.5 px-2 rounded-xl transition-all duration-300 group ${isHistoryOpen ? 'text-primary bg-white/5' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5'}`}
            >
              <History className="w-5 h-5 mb-1 group-hover:scale-110 transition-transform duration-500" />
              <span className="text-[9px] font-bold uppercase tracking-widest font-space-grotesk">History</span>
            </button>
